    ...
    <div className="relative w-full flex items-center justify-center">
      <div className="relative h-full w-4/5 2xl:w-3/4 rounded-lg flex flex-row px-4 pb-4 ">
        <div className="flex flex-col sm:flex-row w-full bg-white rounded-lg border border-gray-200">
          <div className="w-auto h-full sm:h-full flex justify-center sm:flex-1 "><Image src="/images/Amalfi.jpeg" alt="almafi coast" height={960} width={1280} className="rounded-t-lg sm:rounded-none sm:rounded-l-lg"></Image></div>
